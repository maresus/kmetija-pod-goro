...
def _llm_system_prompt_full_kb(language: str = "si") -> str:
    common = (
        ...
        "\n"
        "PRAVILO OBSEGA:\n"
        "Odgovarjaš IZKLJUČNO o Kmetiji Pod Goro: nastanitev, kosila, kmetija, živali, rezervacije, cene, kontakt, lokacija.\n"
        "Za VSAKO drugo temo odgovori: "Za to tematiko vam žal ne morem pomagati — sem asistent Kmetije Pod Goro."\n"
